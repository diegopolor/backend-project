...
novRoutes.post('/historicoFilter', authUserAdmin_1.rolAuthentication, authToken_1.tokenVerify, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    dataSend = unidad ? Object.assign(Object.assign({}, dataSend), { unidad }) : Object.assign({}, dataSend);
    dataSend = destinatario ? Object.assign(Object.assign({}, dataSend), { destinatario }) : Object.assign({}, dataSend);
