...
const querySQL = (sql) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (db.success) {
        try {
            ...
            (_b = db.connection) === null || _b === void 0 ? void 0 : _b.close();
            return { success: true, message: 'Query realizada', data: Result };
        }
        catch (err) {
            return { success: false, message: (_d = (_c = err === null || err === void 0 ? void 0 : err.originalError) === null || _c === void 0 ? void 0 : _c.info) === null || _d === void 0 ? void 0 : _d.message };
        }
    }
    else
...
const saveField = (table, object) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (executedQuery.success) {
        ...
        if ((_e = executedQuery === null || executedQuery === void 0 ? void 0 : executedQuery.message) === null || _e === void 0 ? void 0 : _e.includes('PK_UserToken')) {
            return {
                success: false,
